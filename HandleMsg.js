            ...
            if (isOwnerBot) {
                await aruga.joinGroupViaLink(linkgrup)
                      .then(async () => {
                          ...
                          await aruga.sendText(chekgrup.id, `Hai semuanya~, Im Fitra Bot. Untuk mencari menu tekan perintah ${prefix}menu`)
                      })
            } else {
	...
	case 'dewabatch':
        ...
        case 'bc': //untuk broadcast atau promosi
            ...
            for (let idk of chatz) {
                ...
                if (!cvk.isReadOnly) aruga.sendText(idk, `〘 *F I T R A  B C* 〙\n\n${msg}`)
                if (cvk.isReadOnly) aruga.sendText(idk, `〘 *F I T R A  B C* 〙\n\n${msg}`)
            }
